...
var getCityWeather = function (city) {
  var apiUrl =
    ...
    city +
    "&units=imperial&appid=de863e99a7b087a76baf123be83add0a";
  ...
  fetch(apiUrl).then(function (response) {
    response.json().then(function (response) {
      ...
      document.querySelector("#feels-like").textContent =
        "Temperature: " + response.main.feels_like + "°F";
      ...
      return fetch(
        ...
        .then(function (response) {
          ...
          document.querySelector("#day-1-temp").textContent =
            "Temp: " + response.daily[1].temp.day + "°F";
          document.querySelector("#day-1-humidity").textContent =
          ...
          document.querySelector("#day-2-temp").textContent =
            "Temp: " + response.daily[2].temp.day + "°F";
          document.querySelector("#day-2-humidity").textContent =
          ...
          document.querySelector("#day-3-temp").textContent =
            "Temp: " + response.daily[3].temp.day + "°F";
          document.querySelector("#day-3-humidity").textContent =
          ...
          document.querySelector("#day-4-temp").textContent =
            "Temp: " + response.daily[4].temp.day + "°F";
          document.querySelector("#day-4-humidity").textContent =
          ...
          document.querySelector("#day-5-temp").textContent =
            "Temp: " + response.daily[5].temp.day + "°F";
          document.querySelector("#day-5-humidity").textContent =
